...
var timestamp = setEpochSecondsToZero(originlalTimestamp);
...
patients.once("value", function (snapshot) {
  ...
  document.getElementById("PatientName").innerHTML = "Name: " + patient_data1.username;
  document.getElementById("PatientGender").innerHTML = "Gender: " + patient_data1.gender;
  document.getElementById("PatientAge").innerHTML = "Age: " + patient_data1.age;
  document.getElementById("PatientHeight").innerHTML = "Height: " + patient_data1.height;
  document.getElementById("PatientWeight").innerHTML = "Weight: " + patient_data1.weight;
  document.getElementById("PatientAilments").innerHTML = "Ailments: " + patient_data1.ailment;
  document.getElementById("PatientEmail").innerHTML = "Email Id: " + patient_data1.email;
  document.getElementById("PatientMob").innerHTML = "Mob No: " + patient_data1.mobile;
...
doctor.once("value", function (snapshot) {
  ...
  document.getElementById("DoctorName").innerHTML = "Welcome Dr. " + doctor_data1.username;

  console.log("Doctor data fetched successfully.");
});

patients.once("value", function (snapshot) {
  console.log("Fetching additional patient data...");
  let patient_data = JSON.stringify(snapshot.val(), null, 2);
  let patient_data1 = JSON.parse(patient_data);
  username = patient_data1.username;

  console.log("Additional patient data fetched successfully.");
});

var patientId = localStorage.getItem("patient_unique_id");
console.log("id", id);
var patientsDataRef;
var ecgref;
var ecgref1;
...
console.log("page", page, "timestamp", timestamp);
